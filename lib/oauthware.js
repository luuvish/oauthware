...
var OAuthware = function OAuthware(middleware) {
  ...
  connect.HTTPServer.call(this, [this.session]);
...
fs.readdirSync(__dirname + '/middleware').forEach(function (filename) {
  if (/\.js$/.test(filename)) {
    ...
    Object.defineProperty(exports.middleware, name, {
      get: function () {
        var service = require('./middleware/' + name);
        return function (options) {
          return router(service.apply(null, Array.prototype.slice.call(arguments)));
        };
      },
      enumerable: true
    });
