...
function OAuth1a(options, defaults) {
...
OAuth1a.prototype.login = function login(handle, opts) {
  var self = this;
...
OAuth1a.prototype.logout = function logout(handle) {
  var self = this;
  var sess = handle.session();
 ...
 *  parameter.
 */
OAuth1a.prototype.auth = function auth(handle) {
  var self = this;
  var sess = handle.session();
...
OAuth1a.prototype.api = function api(handle, opts) {
  var self = this;
  var sess = handle.session();
