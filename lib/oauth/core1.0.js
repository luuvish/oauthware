...
OAuth1.prototype.login.check = function check(handler) {
  return true;
};

OAuth1.prototype.login.hook = function hook(handler) {
  return true;
};
...
OAuth1.prototype.auth.check = function check(handler) {
  var self  = this,
      sess  = handler.session(),
      query = handler.query;
...
OAuth1.prototype.auth.hook = function hook(handler) {
  return true;
};
...
OAuth1.prototype.api.check = function check(handler) {
  var self = this,
      sess = handler.session();
...
OAuth1.prototype.api.hook = function hook(handler) {
  return true;
};
