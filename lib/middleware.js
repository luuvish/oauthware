...
function Middleware(middleware) {
  ...
  handle.handle = {
    login: function (req, res, next) {
      middleware.login(middleware.handle(req, res, next));
    },
    logout: function (req, res, next) {
      middleware.logout(middleware.handle(req, res, next));
    },
    auth: function (req, res, next) {
      middleware.auth(middleware.handle(req, res, next));
    },
    api: function (req, res, next) {
      middleware.api(middleware.handle(req, res, next));
    },
    route: function (app) {
